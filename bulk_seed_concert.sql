...
INSERT INTO tmp_seed_concert_names (concert_name) VALUES
                                                      ...
                                                      ('2026 〈현역가왕3〉 전국투어 콘서트 - 서울'),
                                                      ('2026 〈현역가왕3〉 전국투어 콘서트 - 인천'),
                                                      ('2026 〈현역가왕3〉 전국투어 콘서트 - 청주'),
                                                      ('2026 〈현역가왕3〉 전국투어 콘서트 - 울산'),
                                                      ('2026 〈현역가왕3〉 전국투어 콘서트 - 창원'),
                                                      ('2025 〈현역가왕2〉 전국투어 콘서트 - 서울'),
                                                      ('2025 〈현역가왕2〉 전국투어 콘서트 - 부산'),
                                                      ('2024 〈현역가왕〉 전국투어 콘서트 - 서울'),
                                                      ('2024 〈현역가왕〉 전국투어 콘서트 - 부산');
...
FROM (
         ...
         UNION ALL SELECT
                       ...
                       'https://ticketimage.interpark.com/Play/image/large/26/26002287_p.gif',
                       2,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26002287-01.jpg'
         ...
         UNION ALL SELECT
                       ...
                       'https://ticketimage.interpark.com/Play/image/large/25/25013101_p.gif',
                       2,
                       'https://ticketimage.interpark.com/Play/ITM/Data/Modify/2025/11/2025110718472243.jpg'
         ...
         UNION ALL SELECT
                       ...
                       'https://ticketimage.interpark.com/Play/image/large/24/24014696_p.gif',
                       3,
                       'https://ticketimage.interpark.com/Play/image/etc/24/24014696-03.jpg'
         ...
         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2026-02-23 14:00:00','120분','2026-03-01 19:00:00',
                       '2026 〈현역가왕3〉 전국투어 콘서트 - 서울','2026-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/26/26001870_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26001870-01.jpg'

         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2026-02-23 14:00:00','120분','2026-03-01 19:00:00',
                       '2026 〈현역가왕3〉 전국투어 콘서트 - 인천','2026-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/26/26001870_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26001870-01.jpg'
         ...
         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2026-02-23 14:00:00','120분','2026-03-01 19:00:00',
                       '2026 〈현역가왕3〉 전국투어 콘서트 - 청주','2026-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/26/26001870_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26001870-01.jpg'
         ...
         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2026-02-23 14:00:00','120분','2026-03-01 19:00:00',
                       '2026 〈현역가왕3〉 전국투어 콘서트 - 울산','2026-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/26/26001870_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26001870-01.jpg'
         ...
         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2026-02-23 14:00:00','120분','2026-03-01 19:00:00',
                       '2026 〈현역가왕3〉 전국투어 콘서트 - 창원','2026-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/26/26001870_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/26/26001870-01.jpg'

         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2025-02-23 14:00:00','120분','2025-03-01 19:00:00',
                       '2025 〈현역가왕2〉 전국투어 콘서트 - 서울','2025-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/25/25010748_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/25/25010748-02.jpg'

         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2025-02-23 14:00:00','120분','2025-03-01 19:00:00',
                       '2025 〈현역가왕2〉 전국투어 콘서트 - 부산','2025-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/25/25010748_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/25/25010748-02.jpg'

         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2024-02-23 14:00:00','120분','2024-03-01 19:00:00',
                       '2024 〈현역가왕〉 전국투어 콘서트 - 서울','2024-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/24/24001640_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/24/24001640-05.jpg'

         UNION ALL SELECT
                       '2026-01-08 01:11:02','2026-01-08 01:11:02',8,'2024-02-23 14:00:00','120분','2024-03-01 19:00:00',
                       '2024 〈현역가왕〉 전국투어 콘서트 - 부산','2024-02-28 19:00:00',
                       'https://ticketimage.interpark.com/Play/image/large/24/24001640_p.gif',
                       5,
                       'https://ticketimage.interpark.com/Play/image/etc/24/24001640-05.jpg'
...
FROM (
         ...
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-08-16 19:00:00',25000,'스탠딩 에그 Standing Egg "Little Star" - 창원'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-02-28 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-03-01 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-02-28 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 인천'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-03-01 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 인천'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-02-28 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 울산'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-03-01 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 울산'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-02-28 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 창원'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2026-03-01 19:00:00',25000,'2026 〈현역가왕3〉 전국투어 콘서트 - 창원'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-02-28 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-03-01 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-02-28 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 부산'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-03-01 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 부산'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-02-28 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2025-03-01 19:00:00',25000,'2025 〈현역가왕2〉 전국투어 콘서트 - 서울'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2024-02-28 19:00:00',25000,'2024 〈현역가왕〉 전국투어 콘서트 - 부산'
         UNION ALL SELECT '2026-01-08 01:11:02','2026-01-08 01:11:02','2024-03-01 19:00:00',25000,'2024 〈현역가왕〉 전국투어 콘서트 - 부산'
...
FROM `session` s
         ...
         JOIN seq ON seq.n <= CASE h.`hall_type`
                                  WHEN 'SMALL'   THEN 80      --  8 × 10
                                  WHEN 'MEDIUM'  THEN 280     -- 14 × 20
                                  WHEN 'LARGE'   THEN 800     -- 20 × 40
                                  WHEN 'XLARGE'  THEN 3000    -- 30 × 100
                                  WHEN 'XXLARGE' THEN 10000   -- 50 × 200
                                  ELSE 80
    END;
