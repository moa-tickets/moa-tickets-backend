...
-- 0.1) 필요시 HALL 추가
INSERT INTO hall (created_at, updated_at, hall_name, hall_state, hall_type) VALUES (NOW(), NOW(), '블루스퀘어 MOA HALL', 'AVAILABLE', 'SMALL');
INSERT INTO hall (created_at, updated_at, hall_name, hall_state, hall_type) VALUES (NOW(), NOW(), '컨벤션센터 제2전시장', 'AVAILABLE', 'MEDIUM');
INSERT INTO hall (created_at, updated_at, hall_name, hall_state, hall_type) VALUES (NOW(), NOW(), '모아 문화회관', 'AVAILABLE', 'LARGE');
INSERT INTO hall (created_at, updated_at, hall_name, hall_state, hall_type) VALUES (NOW(), NOW(), 'KBC 모아홀', 'AVAILABLE', 'XLARGE');
INSERT INTO hall (created_at, updated_at, hall_name, hall_state, hall_type) VALUES (NOW(), NOW(), '스카이돔', 'AVAILABLE', 'XXLARGE');
