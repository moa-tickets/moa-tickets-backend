...
-- =========================================================
-- 2) 기존 콘서트 정리 (concert_name 기준)
--    FK 순서: ticket → session → concert
-- =========================================================
